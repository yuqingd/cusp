...
def get_model_and_assets(maze_num=None):
  """Returns a tuple containing the model XML string and a dict of assets."""
  if maze_num is not None:
    return common.read_model('point_mass_maze_{}.xml'.format(maze_num)), common.ASSETS
...
@SUITE.add()
def maze(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the maze point_mass task."""
  maze_num = np.random.randint(0,4)
  physics = Physics.from_xml_string(*get_model_and_assets(maze_num=maze_num))
  task = PointMass(randomize_gains=False, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, **environment_kwargs)
...
@SUITE.add()
def maze0(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the maze point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets(maze_num=0))
  task = PointMass(randomize_gains=False, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, **environment_kwargs)
...
@SUITE.add()
def maze1(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the maze point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets(maze_num=1))
  task = PointMass(randomize_gains=False, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, **environment_kwargs)
...
@SUITE.add()
def maze2(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the maze point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets(maze_num=2))
  task = PointMass(randomize_gains=False, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, **environment_kwargs)
...
@SUITE.add()
def maze3(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None):
  """Returns the maze point_mass task."""
  physics = Physics.from_xml_string(*get_model_and_assets(maze_num=3))
  task = PointMass(randomize_gains=False, random=random)
  environment_kwargs = environment_kwargs or {}
  return control.Environment(
      physics, task, time_limit=time_limit, **environment_kwargs)
